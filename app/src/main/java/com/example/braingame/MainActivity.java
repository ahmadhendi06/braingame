...
public class MainActivity extends AppCompatActivity {
    ...
    Button startBtn;
    Button againBtn ; Button button0;  Button button1; Button button2; Button button3;
    TextView sumView; TextView timerView; TextView resultView; TextView pointsView;
